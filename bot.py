...
openai.api_key = "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"
...
TOKEN = 'MTA5MzAxMzAwNzMyOTY2NTEwNQ.GpXSbg.mD9BfhwWfuN3GrLgcCyoFOxFMDrZ-OInzZibG4'
bot.run(TOKEN)

# For more custom buttons
...
'''
    ...
    async def menu1(self, button: discord.ui.Button, interaction: discord.Interaction):
        await interaction.response.send_message("He11o You Clicked Me")
